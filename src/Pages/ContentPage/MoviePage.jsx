...
const MoviePage = () => {
    ...
    useEffect(() => {
        const fetchMovie = async () => {
            try {
                const response = await axios.get(`http://localhost:3001/content/movies/${movieId}`);
                ...
                const userRatingResponse = await axios.get(`http://localhost:3001/content/movies/${movieId}/user-rating`,
                    {
                        params: {
                            movieId: movieId
                        },
                ...
                const ratingCountResponse = await axios.get(`http://localhost:3001/content/movies/${movieId}/rating-count`);
    ...
    const handleRatingChange = async (value) => {
        try {
            ...
            const response = await axios.post(
                `http://localhost:3001/content/movies/${movieId}/rating`,
    ...
    const handleDeleteMovie = async () => {
        try {
            ...
            const response = await axios.delete(`http://localhost:3001/content/movies/${movieId}/delete-movie`);
            if (response.status === 200) {
